...
```
git clone git@github.com:UCL-ARC/CHME0039-projects-ideas.git
```

## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/UCL-ARC/CHME0039-projects-ideas/issues/new/choose
...
9.1 You can navigate branches in https://github.com/UCL-ARC/CHME0039-projects-ideas/branches and removed merged branches by clickling :wastebasket: icon.    
