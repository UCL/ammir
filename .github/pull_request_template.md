...
- [ ] I have read the [`CONTRIBUTING`](https://github.com/UCL/ammir/blob/main/CONTRIBUTING.md) docs
...
- [ ] Make sure your branch is up-to-date with main branch. See step 4 in [`CONTRIBUTING`](https://github.com/UCL/ammir/blob/main/CONTRIBUTING.md#pull-request-pr-and-merge-to-main-branch).
